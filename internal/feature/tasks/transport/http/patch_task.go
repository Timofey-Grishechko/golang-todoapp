...
import (
	...
	core_http_types "github.com/Timofey-Grishechko/golang-todoapp/internal/core/transport/http/types"
)
...
func (h *TasksHTTPHandler) PatchTask(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responseHandler.ErrorResponse(
			err,
			"failed to get taskID from path value",
		)
	...
	if err := core_http_request.DecodeVlidateRequest(r, &request); err != nil {
		responseHandler.ErrorResponse(
			err,
	...
	taskPatch := taskPatchFromRequset(request)
...
func taskPatchFromRequset(request PatchTaskRequest) domain.TaskPatch {
